            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-800 mb-4">Subscribe to our newsletter for the latest job openings.</p>
                        <form className="flex flex-col gap-2">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                />
                            </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-500 text-center text-sm text-gray-800">
